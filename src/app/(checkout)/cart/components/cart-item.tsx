...
import { removeItem } from '@/app/(checkout)/cart/slices/cart.slice';
import styles from './cart-item.module.css';
import Image from 'next/image';
import QuantitySelector from '@/shared/components/ui/QuantitySelector/QuantitySelector';
...
const CartItemView = ({ item }: { item: CartItemType }) => {
